...
global.channelLink = "https://whatsapp.com/channel/0029Vb7DaHA23n3c7vqf9p3A";
global.ytch = "Dᴀᴠɪʟ";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb7DaHA23n3c7vqf9p3A'
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/IF5EydLs4EgHY6f3Sk1uar`
                }, { quoted: message });
                return;
            }
        }
